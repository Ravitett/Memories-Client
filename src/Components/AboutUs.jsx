...
const AboutUs = () => {
    return (
        ...
        style={{
            ...
            <Typography variant='h3'>מי אנחנו?</Typography>
            <Typography>
            ...
            <Typography>
                על ידי הקלקה על סימון הזיכרון במפה יחשפו בפניכם נבכי נשמתם של חיילים רבים מתקופות שונות.
                אנו מעודדים אתכם להוסיף ולשתף ולפרסם את סיפורכם, מחשבותיכם ורגשותיכם כאן.
            </Typography>
        </Card>
    )
}
